...
lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.clulab" %% "processors-main" % "7.5.3",
      "org.clulab" %% "processors-modelsmain" % "7.5.3",
      "org.clulab" %% "processors-corenlp" % "7.5.3",
      "org.clulab" %% "processors-modelscorenlp" % "7.5.3",
      "org.clulab" %% "processors-odin" % "7.5.3",
